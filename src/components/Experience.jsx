...
const experiences = [
    ...
    description: "Developed  Fixed  Foveated  Rendering  (FFR)  pipeline  in  OpenGL  &  C++,  reducing  fragment  shading workload by ~30%. Optimized  GPU  shaders  and  implemented  dynamic  resolution  scaling. ",
    logo: logo3
  },
